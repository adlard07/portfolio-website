...
const TypewriterText = () => {
  ...
  return (
    <span
      ...
      style={{ minWidth: `${longestPhrase.length * 0.7}ch` }}
    >
      {text}
      <span
        className={`${
...
const HeroSection = ({ isDarkMode, toggleTheme }) => {
  ...
  return (
    <section
      className={`min-h-screen flex items-center justify-center py-16 px-4 transition-all duration-500 ${containerClasses} overflow-hidden`}
    >
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xs font-mono mt-8 border-t border-current pt-4 italic">
                * Results may vary. Self-proclaimed excellence not validated by
                peer review. Past performance does not guarantee future
                mediocrity. Coffee dependency not included.
              </p>
            </div>
            <div className="mt-10">
              <a
                ...
                className="inline-block px-6 py-3 border border-current hover:bg-black hover:text-white transition-all duration-300 font-mono text-md tracking-wider"
              >
              ...
              <div className="p-5 space-y-4">
                <div>
                  ...
                  <p className="text-neutral-400 ml-2">
                    Analyzing portfolio worthiness...
                  </p>
                </div>
                <div>
                  <p className="text-yellow-400">$ WARNINGS:</p>
                  <p className="text-neutral-400 ml-2">
                    - Ego levels exceeding recommended limits
                  </p>
                  <p className="text-neutral-400 ml-2">
                    - Coffee consumption: critical
                  </p>
                  <p className="text-neutral-400 ml-2">
                    - 73% of code is Stack Overflow inspired
                  </p>
                </div>
                <div>
                  <p className="text-green-400">$ self_assessment.py</p>
                  <p className="text-white ml-2">
                    ... but hey, the code still works ¯\_(ツ)_/¯
                  </p>
                </div>
