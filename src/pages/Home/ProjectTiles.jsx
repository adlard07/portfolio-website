...
const API_URL =
  "https://rzcfwvihftl75qdx3gkezvloae0vdzef.lambda-url.ap-south-1.on.aws/personal/repo_info/";
const OVERVIEW_URL =
  "https://rzcfwvihftl75qdx3gkezvloae0vdzef.lambda-url.ap-south-1.on.aws/overview/personal/";
  ...
  const fetchOverview = async (repoName) => {
    ...
    try {
      ...
      setSelectedProject((prev) => ({
        ...prev,
        overview: formatText(data.overview),
      }));
    } catch (err) {
      setSelectedProject((prev) => ({
        ...prev,
        overview:
          "Failed to load overview. Apparently, even AI can't make sense of my coding style.",
      }));
    } finally {
    ...
    >
      <main className="max-w-7xl mx-auto p-8">
        ...
        {selectedProject && (
          ...
          >
            <div
              className={`rounded-lg max-w-3xl w-full relative animate-in fade-in overflow-hidden ${
                isDarkMode ? "bg-black" : "bg-white"
              }`}
            >
              {/* Modal header with stripe design */}
              <div
                className={`h-2 w-full ${isDarkMode ? "bg-white" : "bg-black"}`}
              ></div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    {selectedProject.description ||
                      "No description. I was probably too tired to type more words."}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-6">
                    ...
                    >
                      ...
                      {selectedProject.stargazers_count || "0"} stars
                    </div>
                    <div
                      className={`flex items-center ${
                        isDarkMode ? "text-white" : "text-black"
                    ...
                    >
                      ...
                      {selectedProject.forks_count || "0"} forks
                    </div>
                    <div
                      className={`flex items-center ${
                        isDarkMode ? "text-white" : "text-black"
                    ...
                    >
                      <Calendar className="w-5 h-5 mr-2" /> Created:{" "}
                      {formatDate(selectedProject.created_at)}
                    </div>
                  </div>

                  <div
                    className={`border-2 p-6 rounded-lg my-6 max-h-[50vh] overflow-y-auto ${
                      isDarkMode ? "border-white" : "border-black"
                    }`}
                  >
                    {loading ? (
                      <div className="flex flex-col items-center justify-center py-12 space-y-6">
                        ...
                        <div className="relative w-16 h-16">
                          ...
                          ></div>
                          <div
                            className={`absolute inset-0 rounded-full border-t-4 animate-spin ${
                              isDarkMode ? "border-white" : "border-black"
                            }`}
                          ></div>
                        </div>
                      ...
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html:
                            ...
                            "No overview available. Just like my documentation skills.",
                        }}
                      />
                    )}
                  </div>
                  ...
                  <div className="flex justify-center pt-4">
                    <a
                      href={
                        ...
                        `https://github.com/adlard07/${selectedProject.name}`
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`inline-flex items-center px-8 py-3 rounded-none border-2 transition-all duration-300 ${
                        isDarkMode
