...
const BookTiles = () => {
  ...
  return (
    <div className="min-h-screen font-sans bg-gradient-to-br from-gray-50 to-gray-100 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12 font-sans text-center">
        ...
        <div className="columns-1 sm:columns-1 md:columns-2 lg:columns-3 gap-4 space-y-4">
          {books.map((book, index) => (
            ...
            >
              <div className="w-48 aspect-[3/5] relative mx-auto">
                <img
              ...
              <div className="p-6 bg-gradient-to-t from-gray-900/10 to-transparent">
                <h2 className="text-[18px] font-semibold text-gray-800 mb-2 line-clamp-2">
                  {book.title}
                </h2>
