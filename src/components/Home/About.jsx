...
const AboutSection = ({ isDarkMode }) => {
  ...
  return (
    <section className={`py-24 px-4 transition-all duration-500 ${containerClasses}`}>
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group order-1 md:order-2">
            <div className={`aspect-[3/4] w-full max-w-md mx-auto overflow-hidden transition-all duration-500 ${isDarkMode ? 'bg-black' : 'bg-white'} rounded ${borderColor} shadow-2xl`}>
              <img
                src={SelfImage}
