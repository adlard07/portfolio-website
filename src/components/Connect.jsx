  ...
  return (
    <section className="py-16 px-4 bg-black text-white">
      <div className="container mx-auto max-w-6xl text-center">
        <span className="font-display text-sm tracking-widest text-neutral-400">
          THE SOCIAL EXPERIMENT
        </span>
        <h2 className="font-display text-3xl mt-2 mb-8">LET'S CONNECT</h2>
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex gap-8 text-lg justify-center items-center">
            <a
              ...
              className="hover:text-neutral-400 text-4xl transition-colors"
              aria-label="GitHub"
            >
            ...
            <a
              ...
              aria-label="LinkedIn"
            >
              <FontAwesomeIcon icon={faLinkedin} className="w-6 h-8" />
            </a>
            <a
              ...
              aria-label="Twitter"
            >
              <FontAwesomeIcon icon={faTwitter} className="w-6 h-8" />
            </a>
            <a
              ...
              aria-label="Reddit"
            >
              <FontAwesomeIcon icon={faReddit} className="w-6 h-8" />
            </a>
            <a
            ...
            >
              <FontAwesomeIcon icon={faStackOverflow} className="w-6 h-8" />
            </a>
          </div>
        </div>
      </div>
